...
const ENDPOINT = 'https://mcp.hasdata.com/api/mcp?apis=airbnb';
const KEY = process.env.HASDATA_API_KEY;
const TIMEOUT_MS = 30_000;

const EXPECTED = {
    hasdata_airbnb_listing_getAirbnbListings: 'location',
...
test('apis=airbnb exposes exactly two tools', live, async () => {
